##
## File: week05a.py (STAT 3250)
## Topic: Pandas, GroupBy, and more 
## 
...
# The above computations return a Series (like a one-column 
# data frame) so one can apply Series operations on it.
